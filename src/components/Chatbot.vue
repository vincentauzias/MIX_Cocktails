    ...
    <section class="chat-bot">
        <div class="chat-bot-list-container" ref="chatbot">
            <ul class="chat-bot-list">
                <li class="message" v-for="(message, index) in messages" :key="index" :class="message.author">
                    <p>
    ...
    export default {
        ...
        methods: {
            sendMessage() {
                ...
                this.$axios.get(`https://www.cleverbot.com/getreply?key=CC8uqcCcSO3VsRFvp5-uW5Nxvow&input=${this.message}`).then(res => {
                    this.messages.push({
...
<style scoped>
    ...
    .chat-bot-list-container::-webkit-scrollbar { /* WebKit */
        width: 0;
        height: 0;
    }
