        ...
        <div class="contour">
            ...
            <div class="container-card-recipes"
                ...
                <div class="card-recipes-add-comment">
                    <form action="">
                        <textarea  class="form-control" minlength="16" maxlength="100" v-model='User.commentaire'>Laissez un commentaire</textarea>
                        <br/>
                        <input type="submit" value="Envoyer" @click.once='addToAPI'>
                    </form>
                </div>
